...
resource firewall_resource 'Microsoft.Network/azureFirewalls@2020-11-01' = {
  name: firewallName
  location: firewallLocation
  properties: {
    ipConfigurations: [
...
output firewallPrivateIp string = firewall_resource.properties.ipConfigurations[0].properties.privateIPAddress // output firewallPublivIp array = firewallName_resource.properties.hubIPAddresses.publicIPs.addresses
